...
cd /usr/local/bin
wget -O premium-script.tar.gz "https://raw.githubusercontent.com/musivian/premscript/master/premium-script_1.tar.gz"
tar -xvf premium-script_1.tar.gz
rm -f premium-script_1.tar.gz
